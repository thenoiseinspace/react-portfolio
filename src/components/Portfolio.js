    ...
    <div className='about'>
      ...
      <div className='portfolio'>
        <div className="portfolio-card">
            ...
            <button onclick="window.location.href='https://github.com/thenoiseinspace/Ukraine-News-Now';">
            View on GitHub
            </button>
        </div>
        ...
        <div className="portfolio-card">
            ...
            <button onclick="window.location.href='https://github.com/thenoiseinspace/Farmer-Barter';">
            View on GitHub
            </button>
        </div>
        ...
        <div className="portfolio-card">
            ...
            <button onclick="window.location.href='https://github.com/thenoiseinspace/traquer-de-employee';">
            View on GitHub
            </button>
        </div>
        ...
        <div className="portfolio-card">
            ...
            <button onclick="window.location.href='https://github.com/thenoiseinspace/day-planner';">
            View on GitHub
            </button>
        </div>
        ...
        <div className="portfolio-card">
            ...
            <button onclick="window.location.href='https://github.com/thenoiseinspace/ecommerce-backend';">
            View on GitHub
            </button>
        </div>
